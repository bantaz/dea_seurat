...
# outputs
dea_lfc_dotplot_path <- snakemake@output[["dea_dotplot"]] #"/nobackup/lab_bock/projects/macroIC/results/AKsmall/dea_seurat/KOcall_NonTargeting_condition/plots/DEA_LFC_heatmap.png"
...
ggsave_new(filename = "DEA_Dotplot", 
